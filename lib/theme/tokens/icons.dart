...
const List<CategoryIconGroup> categoryIconGroups = [
  CategoryIconGroup('Ăn uống', [
    'restaurant', 'fastfood', 'ramen_dining', 'rice_bowl', 'local_pizza',
    'bakery_dining', 'set_meal', 'nutrition', 'egg_alt', 'icecream',
    'cake', 'local_cafe', 'emoji_food_beverage', 'local_drink',
    'local_bar', 'sports_bar', 'wine_bar'
  ]),
  CategoryIconGroup('Đi lại', [
    'directions_car', 'two_wheeler', 'moped', 'pedal_bike', 'local_taxi',
    'directions_bus', 'train', 'flight', 'directions_boat',
    'local_gas_station', 'local_shipping'
  ]),
  CategoryIconGroup('Nhà cửa & hoá đơn', [
    'home', 'apartment', 'key', 'chair', 'bed', 'kitchen', 'bolt',
    'water_drop', 'wifi', 'cleaning_services', 'soap', 'handyman',
    'construction', 'potted_plant', 'lightbulb'
  ]),
  CategoryIconGroup('Mua sắm & đồ dùng', [
    'shopping_bag', 'local_mall', 'shopping_cart', 'shopping_basket',
    'store', 'checkroom', 'diamond', 'watch', 'card_giftcard',
    'local_florist', 'devices', 'smartphone', 'computer'
  ]),
  CategoryIconGroup('Sức khoẻ & bản thân', [
    'health_and_safety', 'local_hospital', 'medication', 'vaccines',
    'stethoscope', 'spa', 'content_cut', 'science'
  ]),
  CategoryIconGroup('Giải trí', [
    'theater_comedy', 'movie', 'tv', 'music_note', 'headphones',
    'sports_soccer', 'sports_tennis', 'sports_esports', 'casino',
    'photo_camera', 'palette', 'confirmation_number', 'celebration'
  ]),
  CategoryIconGroup('Du lịch', [
    'hotel', 'beach_access', 'luggage', 'hiking', 'terrain', 'park',
    'umbrella'
  ]),
  CategoryIconGroup('Học & làm', [
    'school', 'menu_book', 'work', 'newspaper', 'mail', 'inventory_2'
  ]),
  CategoryIconGroup('Tiền bạc', [
    'payments', 'savings', 'wallet', 'account_balance', 'credit_card',
    'monetization_on', 'attach_money', 'paid', 'currency_exchange',
    'trending_up', 'receipt_long', 'handshake'
  ]),
  CategoryIconGroup('Gia đình & khác', [
    'family_restroom', 'child_care', 'pets', 'favorite', 'groups',
    'church', 'eco', 'agriculture', 'smoking_rooms', 'star', 'schedule',
    'more_horiz'
  ]),
];
