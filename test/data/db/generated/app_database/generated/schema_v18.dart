...
class Jars extends Table with TableInfo<Jars, JarsData> {
  ...
  late final GeneratedColumn<String> goalFlow = GeneratedColumn<String>(
    ...
    defaultValue: const CustomExpression('\'in\''),
  );
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    ...
    defaultValue: const CustomExpression('\'spend\''),
  );
  @override
  List<GeneratedColumn> get $columns => [
    id,
...
class JarGoals extends Table with TableInfo<JarGoals, JarGoalsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  JarGoals(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> jarId = GeneratedColumn<int>(
    'jar_id',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES jars(id)',
  );
  late final GeneratedColumn<int> goalId = GeneratedColumn<int>(
    'goal_id',
    aliasedName,
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES savings_goals(id)',
  );
  late final GeneratedColumn<int> percent = GeneratedColumn<int>(
    'percent',
    aliasedName,
  ...
  @override
  JarGoalsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return JarGoalsData(
      jarId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  JarGoals createAlias(String alias) {
    return JarGoals(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(jar_id, goal_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class JarGoalsData extends DataClass implements Insertable<JarGoalsData> {
  final int jarId;
  final int goalId;
  final int percent;
  const JarGoalsData({
  ...
  JarGoalsData copyWith({int? jarId, int? goalId, int? percent}) =>
      JarGoalsData(
        jarId: jarId ?? this.jarId,
        goalId: goalId ?? this.goalId,
        percent: percent ?? this.percent,
      );
  JarGoalsData copyWithCompanion(JarGoalsCompanion data) {
    return JarGoalsData(
      jarId: data.jarId.present ? data.jarId.value : this.jarId,
      goalId: data.goalId.present ? data.goalId.value : this.goalId,
      percent: data.percent.present ? data.percent.value : this.percent,
  ...
  @override
  String toString() {
    return (StringBuffer('JarGoalsData(')
          ..write('jarId: $jarId, ')
          ..write('goalId: $goalId, ')
          ..write('percent: $percent')
          ..write(')'))
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is JarGoalsData &&
          other.jarId == this.jarId &&
          other.goalId == this.goalId &&
          other.percent == this.percent);
}

class JarGoalsCompanion extends UpdateCompanion<JarGoalsData> {
  final Value<int> jarId;
  final Value<int> goalId;
  final Value<int> percent;
  final Value<int> rowid;
  ...
  JarGoalsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       goalId = Value(goalId);
  static Insertable<JarGoalsData> custom({
    Expression<int>? jarId,
    Expression<int>? goalId,
    Expression<int>? percent,
    Expression<int>? rowid,
...
class DatabaseAtV18 extends GeneratedDatabase {
  ...
  late final JarGoals jarGoals = JarGoals(this);
